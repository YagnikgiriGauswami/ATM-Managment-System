...
public class SignupThree extends JFrame implements ActionListener{
    ...
    SignupThree(String formno){
        ...
        r4 = new JRadioButton("Recruding Deposit Account");
        ...
        c7 = new JCheckBox("I hereby declares that the above enterd details are correct to the best of the my knowledge");
        ...
        if (ae.getSource() == submit){
            ...
            if(c1.isSelected()){
               facility = facility + " ATM card"; 
                ...
                facility = facility + " Mobail Banking";
